...
namespace worse
{
    ...
    public:
        ...
        constexpr Matrix2(F32 const m00, F32 const m01,
                          F32 const m10, F32 const m11)
        ...
        Matrix2 operator+(F32 const rhs) const
        {
        ...
        Matrix2& operator+=(F32 const rhs)
        {
            m00 += rhs;
            m01 += rhs;
            m10 += rhs;
        ...
        Matrix2& operator*=(Matrix2 const& rhs)
        {
            F32 const t00 = m00 * rhs.m00 + m01 * rhs.m10;
            F32 const t01 = m00 * rhs.m01 + m01 * rhs.m11;
            F32 const t10 = m10 * rhs.m00 + m11 * rhs.m10;
            F32 const t11 = m10 * rhs.m01 + m11 * rhs.m11;
            m00           = t00;
            m01           = t01;
            m10           = t10;
            m11           = t11;
        ...
        WORSE_FORCE_INLINE friend F32 Det(Matrix2 const& m)
        {
    ...
    public:
        ...
        Matrix3(F32 const m00, F32 const m01, F32 const m02,
                F32 const m10, F32 const m11, F32 const m12,
                F32 const m20, F32 const m21, F32 const m22)
        ...
        Matrix3 operator+(F32 const scalar) const
        {
        ...
        Matrix3& operator+=(F32 const scalar)
        {
            m00 += scalar;
            m01 += scalar;
            m02 += scalar;
        ...
        Matrix3& operator*=(Matrix3 const& rhs)
        {
            F32 const t00 = m00 * rhs.m00 + m01 * rhs.m10 + m02 * rhs.m20;
            F32 const t01 = m00 * rhs.m01 + m01 * rhs.m11 + m02 * rhs.m21;
            F32 const t02 = m00 * rhs.m02 + m01 * rhs.m12 + m02 * rhs.m22;
            F32 const t10 = m10 * rhs.m00 + m11 * rhs.m10 + m12 * rhs.m20;
            F32 const t11 = m10 * rhs.m01 + m11 * rhs.m11 + m12 * rhs.m21;
            F32 const t12 = m10 * rhs.m02 + m11 * rhs.m12 + m12 * rhs.m22;
            F32 const t20 = m20 * rhs.m00 + m21 * rhs.m10 + m22 * rhs.m20;
            F32 const t21 = m20 * rhs.m01 + m21 * rhs.m11 + m22 * rhs.m21;
            F32 const t22 = m20 * rhs.m02 + m21 * rhs.m12 + m22 * rhs.m22;
            m00           = t00;
            m01           = t01;
            m02           = t02;
            m10           = t10;
        ...
        WORSE_FORCE_INLINE friend F32 Det(Matrix3 const& m)
        {
    ...
    public:
        ...
        constexpr Matrix4(F32 const m00, F32 const m01, F32 const m02, F32 const m03,
                          F32 const m10, F32 const m11, F32 const m12, F32 const m13,
                          F32 const m20, F32 const m21, F32 const m22, F32 const m23,
                          F32 const m30, F32 const m31, F32 const m32, F32 const m33)
        ...
        Matrix4 operator+(F32 const scalar) const
        {
        ...
        Matrix4& operator+=(F32 const scalar)
        {
            m00 += scalar;
            m01 += scalar;
            m02 += scalar;
        ...
        Matrix4& operator*=(Matrix4 const& rhs)
        {
            F32 const t00 = m00 * rhs.m00 + m01 * rhs.m10 + m02 * rhs.m20 + m03 * rhs.m30;
            F32 const t01 = m00 * rhs.m01 + m01 * rhs.m11 + m02 * rhs.m21 + m03 * rhs.m31;
            F32 const t02 = m00 * rhs.m02 + m01 * rhs.m12 + m02 * rhs.m22 + m03 * rhs.m32;
            F32 const t03 = m00 * rhs.m03 + m01 * rhs.m13 + m02 * rhs.m23 + m03 * rhs.m33;
            F32 const t10 = m10 * rhs.m00 + m11 * rhs.m10 + m12 * rhs.m20 + m13 * rhs.m30;
            F32 const t11 = m10 * rhs.m01 + m11 * rhs.m11 + m12 * rhs.m21 + m13 * rhs.m31;
            F32 const t12 = m10 * rhs.m02 + m11 * rhs.m12 + m12 * rhs.m22 + m13 * rhs.m32;
            F32 const t13 = m10 * rhs.m03 + m11 * rhs.m13 + m12 * rhs.m23 + m13 * rhs.m33;
            F32 const t20 = m20 * rhs.m00 + m21 * rhs.m10 + m22 * rhs.m20 + m23 * rhs.m30;
            F32 const t21 = m20 * rhs.m01 + m21 * rhs.m11 + m22 * rhs.m21 + m23 * rhs.m31;
            F32 const t22 = m20 * rhs.m02 + m21 * rhs.m12 + m22 * rhs.m22 + m23 * rhs.m32;
            F32 const t23 = m20 * rhs.m03 + m21 * rhs.m13 + m22 * rhs.m23 + m23 * rhs.m33;
            F32 const t30 = m30 * rhs.m00 + m31 * rhs.m10 + m32 * rhs.m20 + m33 * rhs.m30;
            F32 const t31 = m30 * rhs.m01 + m31 * rhs.m11 + m32 * rhs.m21 + m33 * rhs.m31;
            F32 const t32 = m30 * rhs.m02 + m31 * rhs.m12 + m32 * rhs.m22 + m33 * rhs.m32;
            F32 const t33 = m30 * rhs.m03 + m31 * rhs.m13 + m32 * rhs.m23 + m33 * rhs.m33;
            m00           = t00;
            m01           = t01;
            m02           = t02;
            m03           = t03;
        ...
        WORSE_FORCE_INLINE friend F32 Det(Matrix4 const& m)
        {
