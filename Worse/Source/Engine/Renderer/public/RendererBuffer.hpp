...
namespace worse
{
    ...
    public:
        ...
        math::Matrix4 viewProjectionInverse;
    };
    ...
    public:
        ...
        // clang-format off
        PushConstantData& setTransform(math::Matrix4 const& mat) { transform = mat; return *this; }
        PushConstantData& setMatrix(math::Matrix4 const& mat)    { matrix = mat; return *this; }
